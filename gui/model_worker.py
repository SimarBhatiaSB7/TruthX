...
class ModelWorker(BaseModelWorker):
    ...
    def generate_stream_gate(self, params):
        ...
        self.call_ct += 1
        # print("PPPPPPPPP:",params)
        # print(self.model)
        truthx_params = {}
        if "top_layers" in params.keys():
            try:
                truthx_params["top_layers"] = params["top_layers"]
                truthx_params["edit_strength"] = params["edit_strength"]

                self.model.set_truthx_params(truthx_params)
            except:
                pass
            del params["top_layers"]
            del params["edit_strength"]
